...
/** Dynamic SQL for Oracle ({@code FETCH FIRST}/{@code OFFSET}). */
public final class OracleDynamicSqlGenerator extends AbstractDynamicSqlGenerator {

    public OracleDynamicSqlGenerator(Dialect dialect) {
        super(dialect);
    }
