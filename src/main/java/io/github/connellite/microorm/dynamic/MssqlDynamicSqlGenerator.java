...
/** Dynamic SQL for SQL Server ({@code TOP}, {@code OFFSET}/{@code FETCH}). */
public final class MssqlDynamicSqlGenerator extends AbstractDynamicSqlGenerator {

    public MssqlDynamicSqlGenerator(Dialect dialect) {
        super(dialect);
    }
